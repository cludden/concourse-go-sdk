...
// MockResourceInitArchive is an autogenerated mock type for the ResourceInitArchive type
type MockResourceInitArchive struct {
	mock.Mock
}

// Archive provides a mock function with given fields: _a0, _a1
func (_m *MockResourceInitArchive) Archive(_a0 context.Context, _a1 *Source) (archive.Archive, error) {
...
func (_m *MockResourceInitArchive) Check(_a0 context.Context, _a1 *Source, _a2 *Version) ([]Version, error) {
...
func (_m *MockResourceInitArchive) In(_a0 context.Context, _a1 *Source, _a2 *Version, _a3 string, _a4 *GetParams) (*Version, []sdk.Metadata, error) {
...
func (_m *MockResourceInitArchive) Initialize(_a0 context.Context, _a1 *Source) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockResourceInitArchive) Out(_a0 context.Context, _a1 *Source, _a2 string, _a3 *PutParams) (*Version, []sdk.Metadata, error) {
...
type mockConstructorTestingTNewMockResourceInitArchive interface {
	mock.TestingT
	Cleanup(func())
}

// NewMockResourceInitArchive creates a new instance of MockResourceInitArchive. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewMockResourceInitArchive(t mockConstructorTestingTNewMockResourceInitArchive) *MockResourceInitArchive {
	mock := &MockResourceInitArchive{}
	mock.Mock.Test(t)
